...
import type { ActivityItem, AdminDashboardStats, SystemOverview } from "@/services/types";
...
export default function AdminDashboard() {
  ...
  const [stats, setStats] = useState<AdminDashboardStats>({ totalExamHalls: 0, totalStudents: 0, totalAlertsLogged: 0, examsThisWeek: 0 });
  const [activity, setActivity] = useState<ActivityItem[]>([]);
  const [overview, setOverview] = useState<SystemOverview>({ uptime: "0%", activeCameras: 0, pendingIssues: 0, avgResponseTime: "0s" });
